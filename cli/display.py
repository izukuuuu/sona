...
def print_welcome() -> None:
    ...
    console.print("  [cyan]/case[/cyan]    - 检索案例库（相似案例对照）")
    console.print("  [dim]                 示例: /case 高铁服务争议案例[/dim]")
    console.print("  [cyan]/monitor[/cyan] - 专题监测（创建专题、日报/周报、内存演示）")
    console.print("  [dim]                 示例: /monitor demo 或 /monitor help[/dim]")
    console.print("  [cyan]/wiki[/cyan]    - 知识库问答（answer + sources）")
    console.print("  [dim]                 示例: /wiki 什么是舆情反转？[/dim]")
    console.print("  [cyan]/wiki-approve[/cyan] - 审核并回流高价值 wiki 候选到 output")
    console.print("  [dim]                 示例: /wiki-approve 或 /wiki-approve 关键词[/dim]")
